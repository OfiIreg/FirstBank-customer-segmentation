...
IN_PATH = Path("/home/claude/m4/repo/data/processed/customer_analytics_table.csv")
OUT_PATH = Path("/home/claude/m4/repo/data/processed/customer_model_dataset.csv")
